...
public class BaseClass extends ZBLogging {

	/*
	 * Initialise Webdriver, properties, xls ,creating db connection, generating logs
	 */
	...
	public static void init() throws IOException {
		if (driver == null) {
			...
			app_logs.debug("loading the config property file - good to go");
			...
			if (config.getProperty("browser").equals("chrome")) {
				...
				app_logs.info("This browser is pretty cool to use");
			...
			//Accept parameter - test web site URL
